        ...
        <Box sx={{
            ...
            <Fade in={true} timeout={1000}>
                <Grid container sx={{
                    ...
                    bgcolor: theme.palette.mode === 'dark' ? 'rgba(30, 41, 59, 0.6)' : 'rgba(255, 255, 255, 0.7)',
                    ...
                    <Grid item xs={12} md={5} sx={{
                        ...
                        justifyContent: 'center',
                        alignItems: 'center',
                        background: 'linear-gradient(135deg, rgba(59,130,246,0.2) 0%, rgba(99,102,241,0.05) 100%)',
                        ...
                        <Typography variant="body1" sx={{
                            ...
                            Secure industrial operations portal. Manage requests, operators, and intelligence in real-time.
                        </Typography>
                    </Grid>

                    {/* Right Pane: Login Form */}
                    <Grid item xs={12} md={7} sx={{ p: { xs: 4, md: 8 }, position: 'relative' }}>
